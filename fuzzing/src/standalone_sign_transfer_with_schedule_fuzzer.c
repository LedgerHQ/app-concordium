/*
 * Fuzzer for handle_sign_transfer_with_schedule.
...
#include "handler/sign_transfer_with_schedule.h"
...
int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
    ...
    handle_sign_transfer_with_schedule(&cmd, &flags, /*isInitialCall=*/true);
    return 0;
}
